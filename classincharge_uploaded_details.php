...
// Check if user is logged in and has a class in-charge role
...
$query = "SELECT * FROM od_requests WHERE status='approved' AND classincharge_uname='$classincharge_uname'";
